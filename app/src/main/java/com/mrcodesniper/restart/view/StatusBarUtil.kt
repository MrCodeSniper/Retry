...
//        }
     ...
     * @param activity 目标界面
     */
    fun setTransparentForWindow2(activity: Activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.window.statusBarColor = Color.TRANSPARENT
...
//            activity.getWindow()
//                    .setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS|View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
